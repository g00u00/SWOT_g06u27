...
def swot():
    print('\n<br><div class="row">') 
    print('<h5>Результаты анализа</h5>')
    print('</div>') 
    swot_dictionary = {}
    ...
    print('<h5>swot_result: </h5>', swot_dictionary['strengths'] - swot_dictionary['weaknesses'] + swot_dictionary['opportunities'] - swot_dictionary['threats'])
    print('</div>')    
    return("OK")
...
<ul class="nav nav-tabs card-header-tabs">
    ...
    <li class="nav-item"><a class="nav-link" href="./swot.py?task=edit&element=strengths&function=form_to_qs">strengths</a></li>
    <li class="nav-item"><a class="nav-link" href="./swot.py?task=edit&element=weaknesses&function=form_to_qs">weaknesses</a></li>
    <li class="nav-item"><a class="nav-link" href="./swot.py?task=edit&element=opportunities&function=form_to_qs">opportunities</a></li>
    <li class="nav-item"><a class="nav-link" href="./swot.py?task=edit&element=threats&function=form_to_qs">threats</a></li>
