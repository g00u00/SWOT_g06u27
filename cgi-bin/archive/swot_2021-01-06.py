...
def swot():
    ...
    print('\n<p>')    
    print('<strong>swot_dictionary: </strong>\n<br>',swot_dictionary)
    print('\n<br><strong>swot_result: </strong>', swot_dictionary['strengths'] - swot_dictionary['weaknesses'] + swot_dictionary['opportunities'] - swot_dictionary['threats'])
    print('</p>')    
...
def parameters_of_element(element):
    ...
    for line in read_file.readlines():
        ...
        print('<strong> power: </strong>  %5.2f' % (parameters_dictionary['power']) , end='')
